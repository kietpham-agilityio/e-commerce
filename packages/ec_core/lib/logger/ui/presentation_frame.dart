...
class _ApplicationPreview extends StatelessWidget {
  const _ApplicationPreview({required this.mq, required this.child});
      ...
      child: FittedBox(
        ...
        child: Builder(
          builder: (context) {
            ...
            return Column(
              children: [
                const Text('Application', style: TextStyle(fontSize: 50)),
...
class _LogsPreview extends StatelessWidget {
  const _LogsPreview({required this.talkerTheme});
      ...
      child: FittedBox(
        ...
        child: Builder(
          builder: (context) {
            ...
            return Column(
              children: [
                const Text('Logs preview', style: TextStyle(fontSize: 50)),
                const SizedBox(height: 16),
                Container(
                  decoration: BoxDecoration(
